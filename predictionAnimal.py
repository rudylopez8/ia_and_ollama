...
import os
import numpy as np 
v1 = int(input(" entrez taille : "))
v2 = int(input(" entrez poids : "))
v3 = int(input(" entrez vitesse : "))
v4 = int(input(" entrez longivité : "))
v5 = int(input(" entrez nbBoucle : "))

x_entrer = np.array(([50, 2.5, 40, 5], [250, 250, 60, 15], [150, 65, 60, 12], [125, 80, 24, 20], [170, 60, 50, 20], [370, 700, 57, 25], [65, 14, 50, 8], [190, 60, 65, 16], [v1, v2, v3, v4]), dtype=float) # données d'entrer
y = np.array(([0],[1],[1],[0],[0],[0],[1],[1]), dtype=float) # données de sortie /  1 = carnivor /  0 = herbivore
...
class Neural_Network(object):
  ...
  def predict(self):
    ...
    if(self.forward(xPrediction) < 0.5):
        print("L'animal est herbivor ! \n")
    else:
        print("L'animal est carnivore ! \n")
NN = Neural_Network()
for i in range(v5): #Choisissez un nombre d'itération, attention un trop grand nombre peut créer un overfitting !
    #print("# " + str(i) + "\n")
