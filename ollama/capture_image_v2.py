...
def call_vision_script():
    """
    Appelle le script vision.py pour analyser l'image capturée.
    """
    try:
        print("Lancement de l'analyse de l'image avec vision.py...")
        subprocess.run(["python", "vision.py"], check=True)
    except subprocess.CalledProcessError as e:
        print(f"Erreur lors de l'exécution de vision.py : {e}")
    except FileNotFoundError:
        print("Le script vision.py n'a pas été trouvé.")
